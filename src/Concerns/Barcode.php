...
trait Barcode
{
    public function ConvertToCode39(string $_strDataToEncode, int $_blnAddCheckDigit):string
    {
        $strDataToEncode = $_strDataToEncode;
        $blnAddCheckDigit = $_blnAddCheckDigit;
